          ...
          <div>
            ...
            <div className="flex items-center space-x-4">
              ...
              {!session ? (
                ...
                <Link href="/admin/home" className="bg-red-600 text-white px-8 py-4 rounded-full text-lg font-medium hover:bg-red-700 transition-all transform hover:scale-105 shadow-xl">
                  Manage Here
                </Link>
              ) : (
