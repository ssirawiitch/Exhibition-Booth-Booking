...
export default async function ExhibitionDetailPage( {params} : {params: {eid:string}}) {
    ...
    return(
        <main className="text-center p-5">
            ...
            <div className="flex flex-row my-5">
                <Image src={ exhibitDetail.data.posterPicture } alt="car image" width={0} height={0} sizes="100vw"
                className="rounded-lg w-[30%]"/>
                <div className="text-md mx-5 text-left">{exhibitDetail.data.description}
